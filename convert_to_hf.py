...
name_mapping = {
    "swinl-all_data-q200+50+50-res800-40k-bs16-polylr-entityonly-nosem": "m2f-plus-entityonly-nosem-40k",
    "coco_panoptic_swinl_100ep": "m2f-coco-original"
}
...
def setup_cfg(args: Args):
    ...
    add_maskformer2_config(cfg, plus=True)
...
class OriginalMask2FormerConfigToOursConverter:
    def __call__(self, original_config: object) -> Mask2FormerConfig:
        ...
        config: Mask2FormerConfig = Mask2FormerConfig(
            ...
            # num_labels=model.MASK_FORMER.SEM_EMBED_DIM-1,
...
def get_model_name(checkpoint_file: Path):
    ...
    model_name = name_mapping[model_name_raw]
    return model_name
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--checkpoint_file",
        type=Path,
        help=("xxx.pkl / xxx.pth"),
        # default="runs/swinl-all_data-q200+50+50-res800-40k-bs16-polylr-entityonly-nosem/model_final.pth",
        default="weights/coco_panoptic_swinl_100ep/model_final.pkl"
    )
    parser.add_argument(
        "--config_file",
        type=Path,
        ...
        default="weights/coco_panoptic_swinl_100ep/config.yaml",
    )
    ...
    from mask2former.maskformer_model import MaskFormer as OriginalMask2Former
