...
EXP_NAME=swinl-cocolpp_entitycls_ppptrain_texttrain_mhpval-q200+50+50-res640-8k
python train_net_plus.py \
    ...
    DATASETS.TRAIN "('ppp_train', 'coco_lvis_paco_part_train', 'entity_train_lr_with_cls', 'textocr_train', 'mhp_valid' )" \
