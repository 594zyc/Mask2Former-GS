...
from .common import (
    ...
    AspectRatioAndDatasetGroupedDataset,
    DatasetFromList, 
    MapDataset, 
    ToIterableDataset
)
...
from .samplers.multitask_batch_sampler import MultiDatasetBatchSampler
...
def build_batch_data_loader(
    ...
    *,
    ...
    # the original detectron2 data loader
    ...
    if aspect_ratio_grouping:
        ...
        if dataset_names is None:
            ...
            data_loader = AspectRatioAndDatasetGroupedDataset(data_loader, batch_size, dataset_names)
...
def _train_loader_from_config(cfg, mapper=None, *, dataset=None, sampler=None):
    ...
    return {
        ...
        "dataset_names": cfg.DATASETS.TRAIN if cfg.MODEL.MULTI_DATASET_TRAIN else None,
    }
