...
class AMPTrainer(SimpleTrainer):
    ...
    def run_step(self):
        ...
        # print("self.grad_scaler.scale(losses).backward()")
        # for idx, loss in enumerate(loss_dict.values()):
        #     self.grad_scaler.scale(loss).backward(retain_graph=(idx != len(loss_dict) - 1))
        
        # print("after self.grad_scaler.scale(losses).backward()")
